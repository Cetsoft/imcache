...
/**
 * The Class NonUniqueHashIndex is type of index where indexed value 
 * can have one or more corresponding values.
 */
public class NonUniqueHashIndex implements CacheIndex {

	/** The lock. */
	private Lock lock = new ReentrantLock();
	
	/** The map. */
	private Map<Object,Set<Object>> map = new ConcurrentHashMap<Object, Set<Object>>();
