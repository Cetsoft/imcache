...
/**
 * The concurrent eviction listener interface for receiving eviction events. This class drains cache
 * task queue and executes saveAll function for cache tasks with multiple threads.
 *
