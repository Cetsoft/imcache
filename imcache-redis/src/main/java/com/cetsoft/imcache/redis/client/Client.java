...
/**
 * The Interface Client provides redis commands. Methods in this interface have corresponding redis
 * command with the same name. This class performs operations by the help of Connection and
 * RedisInputStream and RedisOutputStream.
 */
public interface Client {

  /**
   * Ping the server. This command is often used to test if a connection is still alive.
   */
